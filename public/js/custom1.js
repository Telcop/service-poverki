document.addEventListener('turbo:load', function () {
   const allowedPaths = [
    ...
    if (allowedPaths.includes(currentPath)) {
        ...
        const del = document.getElementById('button-del'); // Кнопка группового удаления
        input.required = true;
        ...
        function toggleButtonState() {
            ...
            del.disabled = !isAnyChecked; // Активируем/деактивируем кнопку группового удаления
        }
        ...
        // Добавляем обработчик для кнопки удаления (делаем необязательным поле input c id="button-del")
        if (del && input) {
